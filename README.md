...
This version contains patches by [@Depau](https://github.com/Depau/ESPAsyncWebServer/commits/wi-se-patches) and [@blackhack](https://github.com/blackhack/ESPAsyncWebServer).
